...
var cars={
    Auto:[' Mercedes Classe A','Porsche carrera GT'],
    Moto:['Kavaski Ninja 600 ','Duke vola via'],
    Bici:['Mountain Bike Pellegrini','Bici elettrica bromm broom'],
    Monopattino:['Wind','Bird']
}
